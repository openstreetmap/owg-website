---
title: Post-Mortem - Primary Site outage - 11 June 2022
post_mortem: true
date: 2022-07-20
---
...
- 2022-05-02 - Notification from Equinix of upcoming 5-year maintenance on Power Feed A supplying our servers in Amsterdam (8-hour window)
...
- 2022-06-06 - OpenStreetMap Operations announced the upcoming Cogent network outage maintenance: https://twitter.com/OSM_Tech/status/1533555914351030274
...
- Ops are unsure why connectivity failed. Redundant power meant to be supplied by the Cisco Redundant Power System.
...
- 2022-06-12 04:03 (UTC) - OpenStreetMap Operations acknowledged the outage: https://twitter.com/OSM_Tech/status/1535835250508861440
- 2022-06-12 04:22 (UTC) - OpenStreetMap Operations were able to confirm that Switch-1 was offline during the power maintenance window, as suspected.
- 2022-06-20 - Site visit - Decommission old machines
...
It was expected that during the maintenance of power feed A (MDP-A/MCC-A) the Cisco Redundant Power System would supply Cisco Switch-1 and Cisco Switch-2 from the remaining power feed B (MDP-B/MCC-B). During the installation of the Cisco Redundant Power System in December 2018 this power failure scenario had been tested and confirmed working.

The initial working hypothesis was that the Cisco Redundant Power System power supply connected to power feed B (MDP-B/MCC-B) had failed which caused a full power outage on Switch-1. With Switch-1 offline the uplink to Cogent was unavailable leaving all OpenStreetMap.org services hosted in Amsterdam without connectivity to the Internet (www, API, wiki, planet). Switch-2 remained operational due to its internal power supply being directly connected to power feed B.
